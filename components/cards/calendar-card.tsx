      ...
      <div className="basis-1/2 space-y-6">
        <div className="flex gap-x-2">
          <Image
            ...
            width={24}
            height={24}
            className="md:h-5 md:w-5 xl:h-6 xl:w-6"
          />
          <h2 className="font-poppins text-xs text-[#B9B9B9] md:text-[8px] md:leading-3 xl:text-sm  xl:leading-5">
            Calendrier des rendez-vous
          </h2>
        </div>
        <div className="space-y-6">
          <div>
            <h6 className="mb-1 font-poppins text-base font-medium lg:text-xs xl:text-xl">
              {format(new Date(), 'eeee')}
            </h6>
            <h2 className="font-poppins text-xl font-medium lg:text-base xl:text-4xl">
              {format(new Date(), 'd')}
            </h2>
          </div>
          <div className="space-y-4">
            <div className="h-auto inline-flex space-x-2 rounded-xl bg-custom-radial px-2 py-2 font-roboto text-white">
